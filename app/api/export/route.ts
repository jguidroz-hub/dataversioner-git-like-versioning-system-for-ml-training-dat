  ...
  try {
    ...
    return new NextResponse(JSON.stringify(exportData, null, 2), {
      headers: {
        ...
        'Content-Disposition': `attachment; filename="DataVersioner - Git-like versioning system for ML training datasets and model experiments-export-${new Date().toISOString().split('T')[0]}.json"`,
      },
    });
  } catch (error: any) {
