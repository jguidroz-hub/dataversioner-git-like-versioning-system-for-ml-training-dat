...
const FROM = process.env.EMAIL_FROM || 'DataVersioner - Git-like versioning system for ML training datasets and model experiments <noreply@example.com>';
const APP_NAME = 'DataVersioner - Git-like versioning system for ML training datasets and model experiments';
